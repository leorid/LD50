...
namespace JL
{
	public static class ObjectPool
	{
		...
		public static GameObject Get(GameObject original, Vector3 position, Quaternion rotation, Transform parent)
		{
			...
			//EventHandler.ExecuteEvent(instantiatedObject, "OnGetFromPool");
			instantiatedObject.BroadcastMessage("OnAfterGetFromPool",
		...
		private static void ReturnLocal(GameObject instantiatedObject, int originalInstanceID)
		{
			...
			//EventHandler.ExecuteEvent(instantiatedObject, "OnReturnToPool");
			instantiatedObject.BroadcastMessage("OnBeforeAddToPool",
				SendMessageOptions.DontRequireReceiver);
